...
namespace UnitTestEx.MSUnit.Internal
{
    ...
    public class FunctionTester<TEntryPoint> : FunctionTesterBase<TEntryPoint, FunctionTester<TEntryPoint>> where TEntryPoint : FunctionsStartup, new()
    {
        ...
        internal FunctionTester(bool includeUnitTestConfiguration, IEnumerable<KeyValuePair<string, string>>? additionalConfiguration) : base(new MSTestImplementor(), includeUnitTestConfiguration, additionalConfiguration) { }
    }
}