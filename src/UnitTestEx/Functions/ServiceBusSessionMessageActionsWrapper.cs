...
{
    /// <summary>
    /// Encapsulates the <see cref="ServiceBusSessionMessageActions"/> functionality to enable support within the <see cref="ServiceBusEmulatorTester{TFunction}"/>.
    /// </summary>
    public class ServiceBusSessionMessageActionsWrapper : ServiceBusSessionMessageActions
    {
        ...
        internal ServiceBusSessionMessageActionsWrapper(ServiceBusReceiver receiver, ILogger logger)
        {
            _receiver = receiver;
            _logger = logger;
        }
