...
namespace UnitTestEx.NUnit
{
    ...
    public static class FunctionTester
    {
        ...
        public static FunctionTester<TEntryPoint> Create<TEntryPoint>(bool includeUnitTestConfiguration, IEnumerable<KeyValuePair<string, string>>? additionalConfiguration = null) where TEntryPoint : FunctionsStartup, new() 
